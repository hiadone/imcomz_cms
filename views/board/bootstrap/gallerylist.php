    ...
    <div class="container">
        <div class="row">
			...
			<div class="border_button mg10">
				...
				<?php if (element('is_admin', $view)) { ?>
					<div class="pull-left">
						<div class="btn btn-danger btn-sm" onClick="post_multi_action('multi_delete', '0', '선택하신 글들을 완전삭제하시겠습니까?');"><i class="fa fa-trash-o"></i> 선택삭제하기</div>
					</div>
				<?php } ?>
				<?php if (element('write_url', element('list', $view))) { ?>
					<div class="pull-right">
						<a href="<?php echo element('write_url', element('list', $view)); ?>" class="btn btn-success btn-sm">매체추가</a>
					</div>
					<?php } ?>
				</div>
