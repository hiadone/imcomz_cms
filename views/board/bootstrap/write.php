			...
			<div class="board">
				...
				?>
					...
					<div class="form-horizontal box-table">
						...
						<div class="form-group">
							<label for="post_title_sub" class="col-sm-2 control-label">부 제목</label>
							<div class="col-sm-10 " style=";">
								<input type="text" class="form-control" name="post_title_sub" id="post_title_sub" value="<?php echo set_value('post_title_sub', element('post_title_sub', element('post', $view))); ?>" />
							</div>
						</div>
						...
						<?php if (element('can_post_notice', element('post', $view)) OR element('can_post_secret', element('post', $view)) OR element('can_post_receive_email', element('post', $view))) { ?>
							<div class="form-group">
								...
								<div class="col-sm-10">
									<input type="number" class="form-control px100" name="post_order" value="<?php echo set_value('post_order', (int) element('post_order', element('post', $view))); ?>" />
						...
						?>
							<div class="form-group">
								<label for="<?php echo $file_column; ?>" class="col-sm-2 control-label">메인 이미지 #<?php echo $i+1; ?></label>
								<div class="col-sm-10">
