				...
				<div class="form-group">
					...
					<div class="col-sm-8 form-inline">
						<select name="order_by_field" class="form-control" >
							...
							<option value="post_order desc" <?php echo set_select('order_by_field', 'post_order desc', (element('order_by_field', element('data', $view)) === 'post_order desc' ? true : false)); ?>>옵션정렬</option>
